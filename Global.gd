...
var versionNumber = "release v1.0.1"
...
# music dictionary
var musicDict = {
	"pause": "res://assets/audio/music/SUI_pauseMenu_game_finalEdit_THISONE.mp3",
	...
	"track6" : "res://assets/audio/music/SUI_mainMenu_game_finalEdit_THISONE.mp3",
